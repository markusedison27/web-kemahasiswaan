    ...
    <div class="login-container">
        ...
        <div class="login-card">
            ...
            <div class="text-center mt-3">
                ...
                <a href="{{ route('register') }}" style="font-size:0.85rem;color:#2563eb;font-weight:600;text-decoration:none;margin-left:4px;">Daftar Sekarang</a>
            </div>

            <div class="security-badge">
                <i class="bi bi-shield-fill-exclamation fs-5"></i>
                <div>
                    <strong>Proteksi Keamanan:</strong> Login dilindungi OTP & rate limiting untuk mencegah serangan brute force.
                </div>
            </div>
