...
<div class="otp-card">
    ...
    <div class="subtitle">
        ...
        <span class="email-highlight">{{ session('otp_pending_email') }}</span>
    </div>
    ...
    <form action="{{ route('login.otp.verify') }}" method="POST" id="otpForm">
        ...
        <div class="timer-badge" id="timerBadge">
            ...
            OTP kedaluwarsa dalam <span id="countdown">05:00</span>
        </div>
    ...
    <div class="text-center mt-3">
        ...
        <form action="{{ route('login.otp.resend') }}" method="POST" style="display:inline;">
            @csrf
