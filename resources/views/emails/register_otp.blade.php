                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 28px;font-size:15px;color:#64748b;line-height:1.6;">
                                Terima kasih telah mendaftar di {{ config('app.name') }}. Gunakan kode OTP berikut untuk menyelesaikan proses verifikasi registrasi akun Anda:
                            </p>
                                ...
                                <tr>
                                    <td style="padding:16px 20px;">
                                        <p style="margin:0;font-size:13px;color:#92400e;">
                                            ⚠️ <strong>Kode ini berlaku selama 15 menit</strong> dan hanya bisa digunakan 1 kali. Jangan bagikan kode ini kepada siapapun.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin:0;font-size:14px;color:#94a3b8;line-height:1.6;">
                                Jika Anda tidak mencoba melakukan pendaftaran akun di platform kami, silakan abaikan email ini.
                            </p>
                        </td>
                    </tr>
